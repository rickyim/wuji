...
def resnet34_preact_bin(pretrained=False, progress=True, **kwargs):
    return _resnet('resnet34', BasicBlock, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)

def resnet100_preact_bin(pretrained=False, progress=True, **kwargs):
    return _resnet('resnet100', BasicBlock, [3, 8, 35, 3], pretrained, progress,
                    **kwargs)